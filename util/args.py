...
class ArgumentParserRGBTSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        self.add_argument('--pretrained_dir',
                          ...
                          help='path to the pretrained resnets with different'
                               'encoder block')
        self.add_argument('--time_path', default='', type=str)
        ...
        # epochs
        self.add_argument('--epochs_from', default=0, type=int, metavar='N',
        ...
        self.add_argument('--lr_decay', default=0.97, type=float)
        self.add_argument('--weight_decay', '--wd', default=0.001, type=float,
                          help='weight decay')

        self.add_argument('--num_workers', '-j', type=int, default=0)
        self.add_argument('--n_class', '-nc', type=int, default=9)
        self.add_argument('--gpu', '-g', type=int, default=0)
        ...
        # model
        self.add_argument('--encoder_1', type=str, default='resnet18')
        self.add_argument('--model_name', '-m', type=str, default='RGBTNet')
        ...
        self.add_argument('--encoder_2', type=str, default='mit_b1',
                          choices=['mit_b1', 'mit_b2', 'mit_b3'],
                          help='Wich encoder to use for rgb features.'
                               'if parameter --encoder_thermal is None the same '
                               'encoder is used for the thermal features.')
        ...
        self.add_argument('--encoder_thermal', type=str, default=None,
                          choices=['resnet18', 'resnet34', 'resnet50', 'None'],
                          help='Take a different encoder for the thermal '
                               'features than for the rgb features. Parameter '
                               'will only be used when modality is rgbt.')
        self.add_argument('--modality', type=str, default='rgbt',
                          choices=['rgbt', 'rgb', 'thermal'],
                          help='If modality is rgb or thermal the model '
                               'consists of one encoder and one decoder. If '
                               'modality is rgbt the model consists of two '
                               'decoders for rgb and thermal images '
                               ...
                               'for the segmentation and the thermal prediction'
                               ' respectively.')
        ...
        self.add_argument('--decoder_channels_mode', default='decreasing',
                          ...
                          help='constant: the number of channels in the '
                               ...
                               'ignored.')
        self.add_argument('--fuse_thermal_in_rgb_encoder', default='SE-add',
                          choices=['SE-add', 'add', 'None'],
                          help='Fuses the thermal feature maps in the rgb '
        ...
        self.add_argument('--dataset', default='MFNet',
                          choices=['sunrgbt',
                                   ...
                                   'nyud',
                                   'cityscapes',
                                   'cityscapes-with-thermal',
                                   'scenenetrgbt'])
        self.add_argument('--dataset_dir',
                          #type=str, default='/home/oem/RGBD_Semantic_Segmentation_PyTorch/DATA/NYUDepthv2/',
                          #type=str, default= '/home/oem/wjy/dataset/PST900_RGBT_Dataset/',
                          type=str, default= '../RTFNet-master/dataset/',
                          #type=str, default= '../dataset/FMB_Dataset/',
                          help='Path to dataset root.',)
        self.add_argument('--raw_thermal', action='store_true', default=False,
                          help='Whether to use the raw thermal values instead of'
                               'the refined thermal values')
        ...
        # others
        self.add_argument('--workers', default=8, type=int, metavar='N',
